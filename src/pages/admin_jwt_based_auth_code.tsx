...
function ChangeCredentialsSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!changed) {
      toast.error("Please enter a new Login ID or new password");
      return;
    }
    ...
    <Card className="shadow-sm">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Update your login email and/or password. Current Login ID:{" "}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Leave blank to keep current login email
            </p>
          </div>
          <div className="space-y-2">
...
function UpcomingEventsEditor() {
  ...
  const setEvents = (updated: UpcomingEvent[]) =>
    setDraft((prev) => ({ ...prev, upcomingEvents: updated }));
  ...
  const handleDelete = (id: string) => {
    if (confirm("Delete this event?")) {
      ...
      toast.info("Event removed — click Update to publish");
    }
  };
  ...
  return (
    <div className="space-y-6">
      <Card className="shadow-sm border-dashed border-2 border-primary/20 bg-primary/[0.02]">
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            <Plus className="h-5 w-5 text-primary" /> Add New Event
          </CardTitle>
        </CardHeader>
      ...
      <p className="text-xs text-muted-foreground flex items-center gap-1">
        <GripVertical className="h-3 w-3" /> Drag cards to reorder
      </p>
            ...
            {editingId === event.id ? (
              <div className="space-y-3">
                <Input
                  value={event.title}
                  onChange={(e) =>
                    handleUpdate(event.id, { title: e.target.value })
                  }
                  placeholder="Title"
                />
                <div className="grid gap-3 sm:grid-cols-2">
                  <Input
                    value={event.date}
                    onChange={(e) =>
                      handleUpdate(event.id, { date: e.target.value })
                    }
                    placeholder="Date"
                  />
                  <Select
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleUpdate(event.id, { description: e.target.value })
                  }
...
function ProgramsEditor() {
  ...
  const setPrograms = (updated: Program[]) =>
    setDraft((prev) => ({ ...prev, programs: updated }));
  ...
  const handleDelete = (id: string) => {
    if (confirm("Delete this program?")) {
      ...
      toast.info("Program removed — click Update to publish");
    }
  };
  ...
  return (
    <div className="space-y-6">
      <Card className="shadow-sm border-dashed border-2 border-primary/20 bg-primary/[0.02]">
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            <Plus className="h-5 w-5 text-primary" /> Add New Program
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v: Program["iconType"]) =>
                  setNewProgram({ ...newProgram, iconType: v })
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Learn alongside peers..."
              rows={3}
            />
          </div>
          <Button onClick={handleAdd} className="font-semibold">
              ...
              <div className="space-y-3">
                <div className="grid gap-3 sm:grid-cols-2">
                  <Input
                    value={program.title}
                    onChange={(e) =>
                      handleUpdate(program.id, { title: e.target.value })
                    }
                    placeholder="Title"
                  />
                  <Select
                    ...
                    onValueChange={(v: Program["iconType"]) =>
                      handleUpdate(program.id, { iconType: v })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleUpdate(program.id, { description: e.target.value })
                  }
                  rows={3}
                />
                <Button
...
function EventSectionsEditor() {
  ...
  const setSections = (updated: EventSection[]) =>
    setDraft((prev) => ({ ...prev, eventSections: updated }));
  ...
  const handleDelete = (id: string) => {
    if (confirm("Delete this section?")) {
      ...
      toast.info("Section removed — click Update to publish");
    }
  };
  ...
  return (
    <div className="space-y-6">
      <Card className="shadow-sm border-dashed border-2 border-primary/20 bg-primary/[0.02]">
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            <Plus className="h-5 w-5 text-primary" /> Add New Event Section
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v: EventSection["iconType"]) =>
                  setNewSection({ ...newSection, iconType: v })
                }
              >
                <SelectTrigger>
                  <SelectValue />
              ...
              <div className="space-y-3">
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v: EventSection["iconType"]) =>
                      handleUpdate(section.id, { iconType: v })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleUpdate(section.id, { description: e.target.value })
                  }
                  rows={2}
                />
                <Button
...
function RegistrationEditor() {
  ...
  const updateEventsPage = (data: Partial<EventsPageData>) =>
    setDraft((prev) => ({
      ...prev,
      eventsPage: { ...prev.eventsPage, ...data },
    }));
      ...
      <Card className="shadow-sm">
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Input
              value={eventsPage.registerLink}
              onChange={(e) =>
                updateEventsPage({ registerLink: e.target.value })
              }
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                value={eventsPage.registerText}
                onChange={(e) =>
                  updateEventsPage({ registerText: e.target.value })
                }
          ...
          <div className="space-y-2">
            ...
            <Textarea
              value={eventsPage.registrationDescription}
              onChange={(e) =>
                updateEventsPage({ registrationDescription: e.target.value })
              }
              rows={2}
            />
          </div>
...
function EventPageCardsEditor() {
  ...
  const [editingId, setEditingId] = useState<string | null>(null);
  const [newCard, setNewCard] = useState<Partial<EventPageCard>>({
    title: "",
    description: "",
    extraText: "",
  });

  const setCards = (updated: EventPageCard[]) =>
    setDraft((prev) => ({ ...prev, eventsPageCards: updated }));
  ...
  const handleAdd = () => {
    ...
    setCards([
      ...cards,
      {
        ...
        extraText: newCard.extraText || undefined,
      },
    ]);
  ...
  const handleUpdate = (id: string, data: Partial<EventPageCard>) =>
    setCards(cards.map((c) => (c.id === id ? { ...c, ...data } : c)));
  const handleDelete = (id: string) => {
    if (confirm("Delete this event card?")) {
      setCards(cards.filter((c) => c.id !== id));
      toast.info("Card removed — click Update to publish");
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-sm border-dashed border-2 border-primary/20 bg-primary/[0.02]">
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            <Plus className="h-5 w-5 text-primary" /> Add Event Card
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Past Bootcamp: Summer Chess Camp 2025"
            />
          </div>
          <div className="space-y-2">
            <Label>Description *</Label>
          ...
          <div className="space-y-2">
            <Label>Extra Text (optional)</Label>
            <Textarea
              value={newCard.extraText || ""}
              onChange={(e) =>
                setNewCard({ ...newCard, extraText: e.target.value })
              }
              placeholder="Additional details, cost info, etc."
              rows={2}
            />
          </div>
          <Button onClick={handleAdd} className="font-semibold">
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <Input
                    value={card.title}
                    onChange={(e) =>
                      handleUpdate(card.id, { title: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleUpdate(card.id, { description: e.target.value })
                    }
                    rows={3}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleUpdate(card.id, { extraText: e.target.value })
                    }
                    rows={2}
                  />
                </div>
...
function AboutPageEditor() {
  ...
  const [newFeature, setNewFeature] = useState<Partial<AboutFeature>>({
    title: "",
    description: "",
    iconType: "book",
  });

  const updateAbout = (data: Partial<typeof about>) =>
    setDraft((prev) => ({
      ...prev,
      aboutPage: { ...prev.aboutPage, ...data },
    }));
  ...
  const handleAddFeature = () => {
    ...
    setFeatures([
      ...about.features,
      {
        ...
        iconType: newFeature.iconType || "book",
      },
    ]);
  ...
  const handleUpdateFeature = (id: string, data: Partial<AboutFeature>) =>
    setFeatures(
      about.features.map((f) => (f.id === id ? { ...f, ...data } : f)),
    );
  const handleDeleteFeature = (id: string) => {
    if (confirm("Delete this feature card?")) {
      setFeatures(about.features.filter((f) => f.id !== id));
      toast.info("Feature removed — click Update to publish");
    }
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              value={about.storyParagraphs.join("\n\n")}
              onChange={(e) =>
                updateAbout({
      ...
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">Meet the Coach</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label>Section Title</Label>
              <Input
                value={about.coachSectionTitle}
                onChange={(e) =>
                  updateAbout({ coachSectionTitle: e.target.value })
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                <label className="cursor-pointer">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      reader.onload = () =>
                        updateAbout({ coachPhotoUrl: reader.result as string });
                ...
                {about.coachPhotoUrl && (
                  <Button
                    variant="ghost"
                    size="sm"
                    className="gap-1 text-destructive hover:text-destructive w-fit h-7 px-2"
                    onClick={() => updateAbout({ coachPhotoUrl: undefined })}
                  >
                    <X className="h-3.5 w-3.5" /> Remove (use default)
                  </Button>
                )}
                <p className="text-xs text-muted-foreground">
                  Max 2MB. Leave empty to use default photo.
                </p>
              </div>
            </div>
          </div>
          <div className="space-y-2">
            ...
            <Textarea
              value={about.coachParagraphs.join("\n\n")}
              onChange={(e) =>
                updateAbout({
                  coachParagraphs: e.target.value
                    .split(/\n\s*\n/)
                    .filter(Boolean),
                })
              }
      ...
      <div className="space-y-6">
        ...
        <Card className="shadow-sm border-dashed border-2 border-primary/20 bg-primary/[0.02]">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              <Plus className="h-5 w-5 text-primary" /> Add Feature Card
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label>Icon</Label>
                <Select
                  value={newFeature.iconType || "book"}
                  onValueChange={(v: AboutFeature["iconType"]) =>
                    setNewFeature({ ...newFeature, iconType: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <Button onClick={handleAddFeature} className="font-semibold">
                ...
                <div className="space-y-3">
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v: AboutFeature["iconType"]) =>
                        handleUpdateFeature(feature.id, { iconType: v })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
...
function HomePageEditor() {
  ...
  const updateHome = (data: Partial<HomePageData>) =>
    setDraft((prev) => ({ ...prev, homePage: { ...prev.homePage, ...data } }));
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateHome({ heroTitleAccent: e.target.value })
                }
              />
            </div>
          </div>
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateHome({ secondaryCtaText: e.target.value })
                }
              />
            </div>
          </div>
          <div className="space-y-2">
            ...
            <Input
              value={home.ctaLink}
              onChange={(e) => updateHome({ ctaLink: e.target.value })}
              placeholder="https://..."
            />
            <p className="text-xs text-muted-foreground">
              Used for both the hero and bottom CTA buttons
            </p>
          </div>
        </CardContent>
      </Card>
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label>Section Title</Label>
            <Input
              value={home.ctaSectionTitle}
              onChange={(e) => updateHome({ ctaSectionTitle: e.target.value })}
            />
          </div>
          <div className="space-y-2">
            <Label>Section Description</Label>
            <Textarea
              value={home.ctaSectionDescription}
              onChange={(e) =>
                updateHome({ ctaSectionDescription: e.target.value })
              }
              rows={2}
            />
          </div>
          <div className="space-y-2">
            <Label>Button Text</Label>
            <Input
              value={home.ctaSectionButtonText}
              onChange={(e) =>
                updateHome({ ctaSectionButtonText: e.target.value })
              }
            />
          </div>
        </CardContent>
...
function ContactPageEditor() {
  ...
  const updateContact = (data: Partial<ContactPageData>) =>
    setDraft((prev) => ({
      ...prev,
      contactPage: { ...prev.contactPage, ...data },
    }));
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => updateContact({ pageSubtitle: e.target.value })}
              rows={2}
            />
          </div>
        </CardContent>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateContact({ formRecipientEmail: e.target.value })
                }
                placeholder="email@example.com"
              />
              <p className="text-xs text-muted-foreground">
                The email address the contact form sends to
              </p>
            </div>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateContact({ phoneRaw: e.target.value })}
                placeholder="+19846876038"
              />
            </div>
          </div>
          <div className="space-y-2">
...
function FooterEditor() {
  ...
  const updateFooter = (data: Partial<FooterData>) =>
    setDraft((prev) => ({ ...prev, footer: { ...prev.footer, ...data } }));

  const updateQuickLink = (id: string, data: Partial<FooterQuickLink>) =>
    updateFooter({
      quickLinks: footer.quickLinks.map((l) =>
        l.id === id ? { ...l, ...data } : l,
      ),
    });
  const removeQuickLink = (id: string) =>
    updateFooter({ quickLinks: footer.quickLinks.filter((l) => l.id !== id) });
  const addQuickLink = () =>
    updateFooter({
      quickLinks: [
        ...footer.quickLinks,
  ...
  const updateSocialLink = (id: string, data: Partial<FooterSocialLink>) =>
    updateFooter({
      socialLinks: footer.socialLinks.map((l) =>
        l.id === id ? { ...l, ...data } : l,
      ),
    });
  const removeSocialLink = (id: string) =>
    updateFooter({
      socialLinks: footer.socialLinks.filter((l) => l.id !== id),
    });
  const addSocialLink = () =>
    updateFooter({
      socialLinks: [
  ...
  const quickDrag = useDragReorder(footer.quickLinks, (items) =>
    updateFooter({ quickLinks: items }),
  );
  ...
  return (
    <div className="space-y-8">
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">Brand & Text</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Year is prepended automatically
              </p>
            </div>
          </div>
        </CardContent>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 grid gap-3 sm:grid-cols-2">
                  ...
                  <Input
                    value={link.path}
                    onChange={(e) =>
                      updateQuickLink(link.id, { path: e.target.value })
                    }
                    placeholder="/path"
                  />
                </div>
...
function AdminPanel() {
  ...
  // Safety Check: If siteData is not yet loaded, show a loading state instead of crashing
  if (!siteData) {
    return (
          ...
          <Tabs defaultValue="events" className="space-y-6">
            <TabsList className="grid w-full grid-cols-8 h-12">
              <TabsTrigger value="home" className="gap-1.5 text-xs sm:text-sm">
                <Home className="h-4 w-4 hidden sm:block" /> Home
              </TabsTrigger>
              <TabsTrigger
                value="events"
                className="gap-1.5 text-xs sm:text-sm"
              >
                <Calendar className="h-4 w-4 hidden sm:block" /> Events
              </TabsTrigger>
              <TabsTrigger
                value="programs"
                className="gap-1.5 text-xs sm:text-sm"
              >
                <BookOpen className="h-4 w-4 hidden sm:block" /> Programs
              </TabsTrigger>
              <TabsTrigger
                value="event-sections"
                className="gap-1.5 text-xs sm:text-sm"
              >
                <LayoutGrid className="h-4 w-4 hidden sm:block" /> Events Page
              </TabsTrigger>
              <TabsTrigger value="about" className="gap-1.5 text-xs sm:text-sm">
                <User className="h-4 w-4 hidden sm:block" /> About
              </TabsTrigger>
              <TabsTrigger
                value="contact"
                className="gap-1.5 text-xs sm:text-sm"
              >
                <Mail className="h-4 w-4 hidden sm:block" /> Contact
              </TabsTrigger>
              <TabsTrigger
                value="footer"
                className="gap-1.5 text-xs sm:text-sm"
              >
                <PanelBottom className="h-4 w-4 hidden sm:block" /> Footer
              </TabsTrigger>
              <TabsTrigger
                value="settings"
                className="gap-1.5 text-xs sm:text-sm"
              >
                <Lock className="h-4 w-4 hidden sm:block" /> Settings
              </TabsTrigger>
            </TabsList>
